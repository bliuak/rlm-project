...
# Task 02: both users have at least one entity or human being instance.
...
def user_satisfies_task_02(categories: list[str]) -> bool:
...
def expected_pairs(categories_by_user: dict[int, list[str]]) -> list[tuple[int, int]]:
    qualifying_users = [
        ...
        if user_satisfies_task_02(categories)
    ]
